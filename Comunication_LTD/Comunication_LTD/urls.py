...
from interface.forms import SetPasswordForm2

urlpatterns = [
    path('interface/', include('interface.urls')),
    path('password_reset/done/', auth_views.PasswordResetDoneView.as_view(template_name="password_reset_sent.html")),
    path('reset/<uidb64>/<token>/',auth_views.PasswordResetConfirmView.as_view(template_name="password_reset_form.html",form_class = SetPasswordForm2),name="password_reset_confirm"),
